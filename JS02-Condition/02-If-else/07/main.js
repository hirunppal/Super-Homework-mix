...
let username = prompt("Input me UserName");

let password = prompt("Input me Password");

let user = username ?? "invalid username or password";
let pass = password ?? "invalid username or password";
